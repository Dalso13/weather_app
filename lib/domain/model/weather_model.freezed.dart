...
class _$WeatherModelImpl with DiagnosticableTreeMixin implements _WeatherModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'WeatherModel(time: $time, temperature: $temperature, windSpeed: $windSpeed, weatherCode: $weatherCode)';
  }
...
abstract class _WeatherModel implements WeatherModel {
  const factory _WeatherModel(
      ...
      required final List<num> temperature,
      required final List<num> windSpeed,
      required final List<num> weatherCode}) = _$WeatherModelImpl;
